...
if __name__ == '__main__':
    ...
    obs_size = 4 # The state is [x, x', theta, theta'], but x and x' are always set to 0.
    n_actions = 2 # We can either increase or decrease velocity.
    ...
    for iter_no, batch in enumerate(iterate_batches(env, net, BATCH_SIZE)):
        ...
        obs_v, acts_v, reward_b, reward_m = filter_batch(batch, 100) # Employ the filter_batch function.

        # Prepare for training the NN by zeroing the accumulated gradients.
        optimizer.zero_grad()
